...
The custom rules live in [infra/core/](infra/core/README.md), organized language-first then by
classifier (`infra/core/<language>/<classifier>/`) — **176 rules** (incl. 14 taint-mode dataflow + 14 logic-smell + 6 authz/access-control rules) across the
...
[infra/schema-infra/](infra/schema-infra/README.md) (generated by `detectors/gen_schema_infra.py`).
